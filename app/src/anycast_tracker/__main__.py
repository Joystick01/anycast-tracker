...
result_v4 = subprocess.run(["mtr", "-jzb", "-o", "LDRSNBAWVGJMXI", "-i", "1", "-c", COUNT, "1.1.1.1", "8.8.8.8", "9.9.9.9", "2.16.241.219", "104.16.123.96", "193.99.144.85", "169.229.128.134"], stdout=subprocess.PIPE)
print("Retrieved IPv4 data")
result_v6 = subprocess.run(["mtr", "-jzb", "-o", "LDRSNBAWVGJMXI", "-i", "1", "-c", COUNT, "2606:4700:4700::1111", "2001:4860:4860::8888", "2620:fe::fe:9", "2a02:26f0:3500:1b::1724:a393", "2606:4700::6810:7b60", "2a02:2e0:3fe:1001:7777:772e:2:85", "2607:f140:ffff:8000:0:8006:0:a"], stdout=subprocess.PIPE)
